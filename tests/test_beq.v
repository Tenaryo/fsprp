...
module inst_mem (
    ...
    initial begin
        ...
        {rom[7], rom[6], rom[5], rom[4]}   = 32'h00a00313;
        {rom[11], rom[10], rom[9], rom[8]} = 32'h00628463;
        {rom[15], rom[14], rom[13], rom[12]} = 32'h06300393;
        {rom[19], rom[18], rom[17], rom[16]} = 32'h02a00393;
    end
...
module test_beq;
    ...
    initial begin
        #200;
        `CHECK_EQ(SCP.RF1.regs[7], 32'd42, "t2")
        `PASS("test_beq")
    end
endmodule
